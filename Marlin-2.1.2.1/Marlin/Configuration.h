...
#define STRING_CONFIG_H_AUTHOR "(Azubis, SKR2 config V0.1)" // Who made the changes.
...
//#define DEFAULT_AXIS_STEPS_PER_UNIT {114.285, 95.23, 372, 167}
  #define DEFAULT_AXIS_STEPS_PER_UNIT  {100.1,99.57,400,167}
/**
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT 150 //OLDVALUE = X_CENTER  // X point for Z homing
